...
const AcceptTask = ({ data }) => {
  return (
    <div className="flex-shrink-0 h-full w-[320px] bg-blue-200 p-5 rounded-xl shadow-md">
      ...
      <div className="mt-6 flex space-x-2">
        ...
        <button className="bg-red-500 text-white py-1 px-2 rounded-md hover:bg-red-600 transition duration-300 shadow-md">
          Mark as Failed
        </button>
      </div>
    </div>
